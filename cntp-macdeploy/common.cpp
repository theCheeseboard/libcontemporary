...
QStringList Common::findInPaths(const QString &file, const QStringList &paths) {
    QStringList files;
    for (const QString& path : paths) {
        QDirIterator iterator(path, {file}, QDir::Files | QDir::Hidden, QDirIterator::Subdirectories | QDirIterator::FollowSymlinks);
