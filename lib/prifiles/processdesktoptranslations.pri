unix:!macx {
    ...
    !isEmpty(DESKTOP_FILE):!blueprint {
        ...
        desktop.extra = mkdir -p $(INSTALL_ROOT)$$CNTP_INSTALL_PREFIX/share/applications/ && $$QMAKE_COPY $${OUT_PWD}/$$DESKTOP_FILE $(INSTALL_ROOT)$$CNTP_INSTALL_PREFIX/share/applications/
        INSTALLS += desktop
    ...
    !isEmpty(DESKTOP_FILE_BLUEPRINT):blueprint {
        ...
        desktopbp.extra = mkdir -p $(INSTALL_ROOT)$$CNTP_INSTALL_PREFIX/share/applications/ && $$QMAKE_COPY $${OUT_PWD}/$$DESKTOP_FILE_BLUEPRINT $(INSTALL_ROOT)$$CNTP_INSTALL_PREFIX/share/applications/
        INSTALLS += desktopbp
